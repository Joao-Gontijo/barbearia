<template>
  <div>
    <div class="container">
      ...
      <form novalidate="true" @submit.prevent="checkEmail(), cadastrarCpf(), salvar(), listar()">
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr v-for="pessoa of pessoas" :key="pessoa.id">
            ...
            <td>{{ pessoa.email }}</td>
            <td>
              <button @click="editar(pessoa), this.listar()" class="button is-success"><i class="material-icons">Editar </i></button>
              <button @click="remover(pessoa), this.listar()" class="button is-danger"><i class="material-icons">Excluir </i></button>
            </td>
          </tr>
        </tbody>
      </table>
